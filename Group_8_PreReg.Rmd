...
![A simulated prediction of moose pellet counts in relation to (A) distance from main roads, (B) distance from forest roads, (C) wolf territory, (D) time since wold establishment, (E) forest stage, (F) pine proportion, and (G) the interaction between forest class and wolf territory. All predictor variable data were simulated, and simulation procedures were informed by the original study's data deposited by Ausilio et al (2021). Lines in plots (A), (B), (D), and (F) represent fitted values and standard errors.](Plots/mooseabundance_marginaleffects_03Oct21_sjPlot.png)
